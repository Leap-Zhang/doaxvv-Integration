...
export const UI = {
  zh: {
    'admin.home': '首页', 'admin.girls': '女孩图鉴', 'admin.swimsuits': '泳装图鉴', 'admin.skills': '技能图鉴', 'admin.tools': '工具', 'admin.guide': '系统指南', 'admin.community': '社区攻略',
  ...
  en: {
    'admin.home': 'Home', 'admin.girls': 'Girls', 'admin.swimsuits': 'Swimsuits', 'admin.skills': 'Skills', 'admin.tools': 'Tools', 'admin.guide': 'Guides', 'admin.community': 'Community',
  ...
  ja: {
    'admin.home': 'ホーム', 'admin.girls': 'ガールズ', 'admin.swimsuits': '水着図鑑', 'admin.skills': 'スキル図鑑', 'admin.tools': 'ツール', 'admin.guide': 'ガイド', 'admin.community': 'コミュニティ',
